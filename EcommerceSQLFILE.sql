...
CREATE TABLE `productbrand` (
  ...
  `companyImg` longtext NOT NULL,
  `companyBankInfo` longtext NOT NULL,
  `companyBankBranch` longtext NOT NULL,
  `companyBankBranchCode` int(10) DEFAULT NULL,
  PRIMARY KEY (`companyID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `productbrand` */

insert  into `productbrand`(`companyID`,`companyName`,`companyDetails`,`companyAddress`,`companyEmail`,`companyContact`,`companyImg`,`companyBankInfo`,`companyBankBranch`,`companyBankBranchCode`) values (1,'Samsung','The paragraph form refers to a group of sentences focusing on a single topic. There are three main parts of a paragraph: Topic sentence - it has the main idea. Supporting sentences - details that relate to and support the topic sentence.','The paragraph form refers to a group of sentences focusing on a single topic. There are three main parts of a paragraph: Topic sentence - it has the main idea. Supporting sentences - details that relate to and support the topic sentence.','abc@yahoo.com','03004577989','https://mk0valuewalkgcar7lmc.kinstacdn.com/wp-content/uploads/2016/09/Samsung-Logo.jpg','UBL','4024007135212115',3),(2,'Nike','Paragraph\r\n','Address','xyz@yahoo.com','0314544778','https://www.desktopbackground.org/download/800x600/2014/09/19/827405_nike-logo-free-download-image-id-1447-7hdwallpapers_3275x2400_h.jpg','HBL','4916652930367241',1),(3,'Nikon','This is a Paragraph\r\n','Address1\r\n','yz@yahoo.com','0312445557','https://cdn.freebiesupply.com/logos/thumbs/2x/nikon-7-logo.png','UBL','4539103859534921',452),(4,'HP','This is a paragraph\r\n','Address2\r\n','softtrack@gmail.com','0324656546','https://s3.amazonaws.com/freebiesupply/thumbs/2x/hewlett-packard-logo.png','Bank Al-Habib\r\n','4929746270570391',4),(5,'Dawlance','This is a Paragraph\r\n','Address3\r\n','dawlence@gmail.com','0321547789','https://c.express.pk/2013/06/133675-Dawlance-1370027132-922-640x480.JPG','MCB\r\n','4532003474407056',64),(6,'Garnier','This is a Paragraph\r\n','Address4\r\n','garnier@gmail.com','0322154546','http://www.surisasurisa.com/wp-content/uploads/2016/09/Garnier-Logo.png','Bank Alfalah','6011355393967825',521);
